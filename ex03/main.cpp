...
/*   Updated: 2025/02/13 10:13:33 by aklimchu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main() {
	...
	std::cout << "//----------------Let's create some interns and test them--------------//" \
		<< std::endl << std::endl;
	...
	AForm* rrf2;
	rrf2= someRandomIntern.makeForm("some form", "Bender");

	AForm* rrf3;
	rrf3 = someRandomIntern.makeForm("shrubbery creation", "Steve");
	rrf3->beSigned(*Jordan);
	rrf3->execute(*Jordan);

	AForm* rrf4;
	rrf4 = someRandomIntern.makeForm("presidential pardon", "");
	rrf4->beSigned(*Jordan);
	rrf4->execute(*Jordan);
